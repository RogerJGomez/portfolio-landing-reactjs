    ...
    return (
        <div className="contact-body"> 
            <Grid className="contact-grid">
                <Cell col={6}>
                    <Fade left>    
                        <img draggable="false" className="profile-pic" src="/cartoon-rg.png" alt="profile"/>
                    <h2>Roger Gómez</h2>
                    <p>Front-end developer from Venezuela. Currently working at an Argentinian marketing agency, <a style={{textDecoration:'none', color:'white', fontWeight:'bold'}} target="_blank" rel="noopener noreferrer" href="https://clichead.com/">Clichead</a>, 
